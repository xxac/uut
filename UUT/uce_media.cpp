...
//add 2015-09-16, write NCB for each module
BOOL NANDEndPartialWriteNCB()
{
    return DeviceIoControl(
        ghStore,
        IOCTL_DISK_VENDOR_END_WRITE_NCB,
        &g_NANDWrtImgInfo,
        sizeof(NANDWrtImgInfo),
        NULL,
        NULL,
...
// add 2015-09-16,write NCB for each module
BOOL EndPartialWriteNCB()
{   
	return NANDEndPartialWriteNCB();
}
